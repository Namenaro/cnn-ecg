...
import pickle
from Functions_for_ae_on_QRS import *
...
# decoder = load_model('save model AE\\decoder_model.h5')
# encoder = load_model('save model AE\\encoder_model.h5')
# autoencoder = load_model('save model AE\\autoencoder_model.h5')
...
for i in range(20):
	...
	# plt.show()
	predicted_data = encoder.predict(data2) 
	start = predicted_data[0]
	end = predicted_data[-1]
